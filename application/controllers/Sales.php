...
/*    public function Create(){
   ...
   public function Return_Confirm(){
        ...
        $entrydate  =   strtotime(date('Y-m-d h:i:sa'));
...
echo " <div class='card-body pos_receipt'>
        <div class='receipt_header'>
          ...
          <p class='company-info' style='padding-bottom:5px;margin-top:-10px;'>
            <span style='text-align:center;'><img src='logo.png' class='img-responsive text-center' style='width:120px;height:auto;'></span>
        ...
        foreach($invoice_details as $value):
            ...
            <td style='right;font-size: 12px;font-weight: 600;color: #000'>";echo $id; echo"</td>
              ...
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$value->total_price .</td>              
            </tr>";
          ...
          echo "</tbody>
            ...
            <td></td>
              ...
              <td style='right;font-size: 12px;font-weight: 600;color: #000'> $invoice->due_amount .</td>
            </tr>
            <tr>
            <td></td>
            <td></td>
              <td colspan='1' style='right;font-size: 12px;font-weight: 600;color: #000'>Paid</td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$invoice->paid_amount .</td>
            </tr>
            <tr>
            <td></td>
            <td></td>
              <td colspan='1' style='right;font-size: 12px;font-weight: 600;color: #000'>Total Amount</td>
              <td style='right;font-size: 12px;font-weight: 600;color: #000'>$invoice->total_amount .</td>
            </tr>
          </table>
        </div>
