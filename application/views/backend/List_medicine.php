                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="text" name="box_price" class="form-control totalboxprice" placeholder="Box Price">
                ...
                $(document).ready(function () {
                    $(".medicineid").click(function (e) {
                        ...
                        $.ajax({
                            ...
                            $('#medicinefORM').find('[id="type"]').val(response.mvalue.form).trigger('change').end();
