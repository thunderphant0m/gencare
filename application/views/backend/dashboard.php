...
-->
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="align-self-center m-l-20">
                                    ...
                                    <h5 class="text-muted m-b-0"><a href="<?php echo base_url(); ?>invantory/Stock_short">Short of Stock<div style="position: sticky;"><span class="label label-rouded label-info pull-right"><?php echo count($sortstock); ?></span></div></a></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" style="position: relative; left:15%;">
                    <!-- Card -->
