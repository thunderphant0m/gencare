...
<?php  $this->load->view('backend/sidebar');?>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Ambulance</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="#" class="text-white"  data-toggle="modal" data-target=".bs-example-modal-lg"><i class="" aria-hidden="true"></i> Add Ambulance</a></button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Manage Ambulance </h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive ">
                                    <table id="myTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           <?php foreach($ambulance as $value): ?>
                                            <tr>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Add Ambulance Information</h4>
        ...
        <script>
             $("#submit").on("click", function(event) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>help/add_ambulance",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        'name': $('#name').val(),
