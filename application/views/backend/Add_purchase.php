                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">                     
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Purchase <span class="pull-right date-display"><?php date_default_timezone_set("Asia/Singapore"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
        ...
        <script type="text/javascript">
                                        ...
                                        //var target = $(this).parent().parent().children().next().next().children();
                                                $.ajax({
                                                    ...
                                                    $(parentTR).find('[name="stock[]"]').val(response.medicinevalue.instock).end()=0;
