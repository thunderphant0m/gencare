            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="m-b-0 ">Today's Sales Report</h4>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-daterange input-group" id="date-range">
                                                <input type="text" class="form-control start" name="start" value="<?php echo date("m/d/Y") ?>" readonly />
                                                <span class="input-group-addon bg-info b-0 text-white">to</span>
                                                <input type="text" class="form-control end" name="end" value="<?php echo date("m/d/Y", strtotime("+1 day")); ?>" hidden />
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="submit" name="purchase" class="form-control reportsales" placeholder="" value="Today's Report">
                                        </div>
                                    </div>
