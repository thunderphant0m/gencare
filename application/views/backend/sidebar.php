                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-medkit"></i><span class="hide-menu">Medicine </span></a>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url();?>Medicine/Create">Add Product </a></li>
                                <li><a href="<?php echo base_url();?>Medicine/View">Manage Product</a></li>
<!--                                <li><a href="<?php echo base_url();?>Medicine/Barcode">Barcode Print</a></li>-->
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-medkit"></i><span class="hide-menu">Product</span></a>
...
<!--                                <li><a href="<?php echo base_url();?>Medicine/Barcode">Barcode Print</a></li>-->
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-building-o"></i><span class="hide-menu"> Inventory </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url();?>invantory/Stock_actual">Actual Stock </a></li>
                            </ul>
                        </li>
