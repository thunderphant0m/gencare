            ...
            <div class="flashmessage"></div>
                ...
                <div class="row m-b-10"> 
                    ...
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url('Medicine/View');?>" class="text-white"><i class="" aria-hidden="true"></i> Manage Product </a></button>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Product <span class="pull-right"><?php date_default_timezone_set("Asia/Singapore"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-12">
                                                        <input type="number" name="barcode" id="barr" class="form-control barcode" placeholder="" value="<?php echo rand(100000000,1500000000)?>" required >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 col-sm-12">Type of Item</label>
                                                    <div class="col-md-9 col-sm-12">
                                                        <select name="item_type" class="select2 item_type" id="" style="width:100%" required>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 col-sm-12">Number of Item per Batch:</label>
                                                    <div class="col-md-9 col-sm-12">
                                                        <input type="number" name="box_size" class="form-control boxitem" placeholder="Items per Batch" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 col-sm-12">Calculated total # of Items per package:</label>
                                                    <div class="col-md-9 col-sm-12">
                                                        <input type="number"  min="0" name="box_size" class="form-control boxsize" placeholder="Total # of Items" readonly required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 col-sm-12">Number of Batches in a package:</label>
                                                    <div class="col-md-9 col-sm-12">
                                                        <input type="number" name="box_size" class="form-control boxbtch" placeholder="Batches/pckg" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-12">
                                                        ...
                                                        <input type="number" name="box_price" class="form-control totalboxprice box_price" placeholder="Box Price">
                                        ...
                                        <div class="col-md-9 col-md-offset-3">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 col-sm-12" hidden>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 col-sm-12"hidden>Take Photo </label>
                                                    <div class="col-md-9 col-sm-12">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3 col-sm-12" hidden>Canvas Photo </label>
                                                    <div class="col-md-9 col-sm-12">  
        ...
        function takePhoto() {
            ...
            // $("#formid").on('submit', function(e) {
               ...
               if(img.length == 0){
                ...
                var box_batch = $(".boxbtch").val();
                var box_item = $(".boxitem").val();
...
/*        function savePhoto() {
            ...
            $.ajax({
                ...
                <script type="text/javascript">
                    $('.boxsize , .trade_price').on('input', function() {
                        var boxprice = $('.boxsize').val();
                        var mrp = $('.trade_price').val();
                ...
                <script type="text/javascript">
                    $('.boxbtch , .boxitem').on('input', function() {
                        var boxbatch = $('.boxbtch').val();
                        var boxitem = $('.boxitem').val();
                        console.log('boxitem');
                        $('.boxsize').val((boxbatch * boxitem ? boxbatch * boxitem : 0));
