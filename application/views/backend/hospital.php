...
<?php  $this->load->view('backend/sidebar');?>
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Hospital</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="#" class="text-white"  data-toggle="modal" data-target=".bs-example-modal-lg"><i class="" aria-hidden="true"></i> Add Hospital</a></button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Add Hospital Information</h4>
        ...
        <script>
             $("#submit").on("click", function(event) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>help/add_hospital",
                    type: "POST",
                    dataType: 'json',
                    data: {
                        'name': $('#name').val(),
