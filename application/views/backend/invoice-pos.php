                          ...
                          <div class="row">
                            <div class="col-md-6">
                                <span class="custom-text-button">
                                  Date:
                                  <?php date_default_timezone_set("Asia/Singapore"); echo date("j  M y") ?>                                    
                                </span>
                            </div>
                            <div class="col-md-6">
                                <span class="custom-text-button">
                                  Time:
                                  <?php date_default_timezone_set("Asia/Singapore"); echo date("h:i A") ?>                                  
                                </span>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row pos-remove-spacing">
                            <div class="col-md-4" style="">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control proval" name="proval" placeholder="Barcode"  id="product_name" tabindex="2" autocomplete="off">                                
                              </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2" style="">
                              <div class="form-group">
                                <input type="number" min="0" oninput="this.value = Math.abs(this.value)" class="form-control qty" name="qty" min="0" max="" id="qty" placeholder="Qty " required tabindex="4" autocomplete="off">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="input-group">
                                ...
                                <input type="number" min="0" oninput="this.value = Math.abs(this.value)" class="form-control stock" name="stock" min="0" max="" id="stock" placeholder="Stock " readonly tabindex="4" >
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="row form-group">
                            <div class="col-md-5">
                              <label for="example-text-input" class=" col-form-label pos-label">Total
                              </label>
                            </div>
                            <div class="col-md-7">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-md-7">
                              <input class="form-control pay" type="text" name="pay" min="0" value="" style="" tabindex="-1" required="1">
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col-md-5">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-md-7">
                              <input class="form-control due" name="due" type="text" value=""  style="" tabindex="-1" hidden >
                            </div>
                          </div>
...
<!--                              <label for="example-text-input" id="sales" class="col-form-label" style="color:#007bff">
                      ...
                      <script>
                        var qtyy = document.getElementById("qty");
                        var stockk = document.getElementById("stock");
