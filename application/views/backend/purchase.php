        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="<?php echo base_url()?>Purchase/Create" class="text-white"><i class="" aria-hidden="true"></i> Add Purchase</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">Manage Purchase <span class="pull-right"><?php date_default_timezone_set("Asia/Singapore"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>                            
                            <div class="card-body">
