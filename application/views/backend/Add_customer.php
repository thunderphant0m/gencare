                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">                                
                                <h4 class="m-b-0 text-white">New Customer <span class="pull-right date-display"><?php date_default_timezone_set("Asia/Singapore"); echo date("l jS \of F Y h:i:s A") ?></span></h4>
                            </div>
                            <div class="card-body">
